...
class PdfExportService {
  static Future<File> generateTransactionReport({
    ...
    for (final txn in transactions) {
      ...
      categoryTotals[categoryId] = (categoryTotals[categoryId] ?? 0) + txn.amount.abs();
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.SizedBox(height: 10),
          _buildTransactionTable(transactions, currencyFormatter, dateFormatter),
        ],
    ...
    final startDate = dateFormatter.format(dateRange.start).replaceAll(' ', '_').replaceAll(',', '');
    final endDate = dateFormatter.format(dateRange.end).replaceAll(' ', '_').replaceAll(',', '');
      ...
      children: [
        ...
        pw.TableRow(
          ...
          children: [
            ...
            _buildTableCell('%', isHeader: true, alignment: pw.Alignment.centerRight),
          ],
        ),
        // Data rows
