...
class CurrencyInfo {
  ...
  /// Whether [code] is a crypto/non-fiat currency. The currency API mixes fiat
  /// with hundreds of crypto tokens and precious metals; anything not in the
  /// ISO 4217 fiat allowlist is treated as non-fiat so new tokens are hidden by
  /// default without needing to maintain a crypto list.
  static bool isCrypto(String code) =>
      !fiatCurrencyCodes.contains(code.toUpperCase());

  /// Active ISO 4217 fiat currency codes shown by default in the picker.
  static const Set<String> fiatCurrencyCodes = {
    'AED',
    'AFN',
    'ALL',
    'AMD',
