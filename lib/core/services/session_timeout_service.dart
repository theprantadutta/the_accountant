...
class SessionTimeoutService {
  ...
  static const int _warningDuration = 5 * 60; // 5 minutes warning before timeout
  ...
  void _resetTimers() {
    ...
    // Start new timers
    _warningTimer = Timer(Duration(seconds: _timeoutDuration - _warningDuration), _showWarning);
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text('Your session will expire in 5 minutes due to inactivity. Do you want to stay signed in?'),
            actions: [
              TextButton(
                onPressed: () {
